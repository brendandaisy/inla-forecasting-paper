...
model_formula <- function(
        ...
        temporal=c("ar1", "rw2"),
        spatial=c("iid", "exchangeable", "besag", "besagproper") # 7/26 you noticed besagproper was indeed faster and also had slighly smaller prediction intervals for covid :)
) {
    seasonal <- case_match(
        seasonal,
        "none" ~ "",
