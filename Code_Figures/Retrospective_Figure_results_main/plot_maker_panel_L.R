...
#write_csv(plot_df_all, "../data/plot_df_a.csv")

#write_csv(truth_df, "../data/truth_df.csv")
...
#generate plots 
##############
plots_all <- generate_plots(plot_df_all, truth_df)
combined_plot <- plot_grid(plotlist = plots_all, ncol = 1, align = "v", rel_heights = c(1, 1, 5))
print(combined_plot)

#save_plot("../Figures/fig4_panelA.pdf", combined_plot, base_width = 6, base_asp = .5, bg = "white")



################
#Maps - no summer months
#################
...
#write_csv(score_graph_location_rsv, "../data/score_graph_location_rsv.csv")

#write_csv(score_graph_location_flu, "../data/score_graph_location_flu.csv")

#write_csv(score_graph_location_covid, "../data/score_graph_location_covid.csv")


######################
#Prepare graph with function
########################
