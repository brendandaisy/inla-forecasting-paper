...
```{r}
#need US so I need to make these 
...
#for (mod in names(plot_list)) {
  #save_plot(paste0("/Users/maya/Desktop/inla-forecasting-paper-main/figure/sup_date_", mod, ".png"), 
...
#output_dir <- "/Users/maya/Desktop/inla-forecasting-paper-main/Supplemental_figures/results_1/"
...
```{r}
#ggsave("PIC_Retro_location.png", plot = stacked_plots, width = 8, height = 10, dpi = 300, bg = "white") 
```
...
```{r}
#ggsave("PIC_Retro_horizon.png", plot = stacked_plots, width = 10, height = 6, dpi = 300, bg = "white") 
```
