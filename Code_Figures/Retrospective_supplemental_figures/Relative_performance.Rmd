...
#print(plot_list_pb[["COVID-19 Model"]])
#print(plot_list_pb[["Influenza Model"]])
#print(plot_list_pb[["RSV Model"]])
...
for (i in seq_along(diseases_truth)) {
  ...
  #ggsave(filename = file_name, plot = stacked_plot, path = "/Users/maya/Desktop/inla-forecasting-paper-main/Supplemental_figures/results_1/", width = 8.8, height = 5.5, units = "in", bg = "white")
}
```
