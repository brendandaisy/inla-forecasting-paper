...
#save_plot("/Users/maya/Desktop/inla-forecasting-paper-main/Supplemental_figures/results_1/sup_hor_simple.png", slide12, base_width = 8, base_asp = 1.7, bg = "white")

```

#panel2
#do all the scoring stuff
```{r}
...
s12 <- ggplot(score_all_ht2, aes(x = horizon, y = proportion_better_than_baseline, color = model)) +
  ...
  #geom_errorbar(aes(ymin = lower_quantile, ymax = upper_quantile), width = 0.2, size = 1) +  # Add error bars
  #geom_hline(yintercept = 1, linetype = "dashed", color = "azure4", size = 1) +
  labs(
       x = "Horizon",
...
#save_plot("/Users/maya/Desktop/inla-forecasting-paper-main/Supplemental_figures/results_1/sup_proportion.png", s12, base_width = 10,  base_height = 6, bg = "white")
```

```{r}
combined_plot <- slide12 + s12 + plot_layout(ncol = 2, widths = c(1, 1))  # Make plot2 wider
print(combined_plot)
#ggsave("/Users/maya/Desktop/inla-forecasting-paper-main/Supplemental_figures/results_1/combined_plot_horizon.png", combined_plot, width = 14, height = 7)
```
