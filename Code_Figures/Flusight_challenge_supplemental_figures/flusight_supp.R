...
#ggsave("../Figures/PIC_date_Flusight_counts.png", plot = stacked_plots, width = 10, height = 6, dpi = 300, bg = "white") 
...
#ggsave("../Figures/PIC_location_Flusight.png", plot = stacked_plots, width = 8, height = 10, dpi = 300, bg = "white")  
...
#ggsave("../data/PIC_horizon_Flusight.png", plot = stacked_plots, width = 10, height = 6, dpi = 300, bg = "white") 

#####################
#Horizon plot more detailed
#####################
truth_US <- truth_df |>
  filter(location_name == "US") |>
  select(date, count) |>
...
# Step 3: Filter for baseline model
...
#ggsave("../data/horizon_supp_flusight2.png", plot = plot, width = 8, height = 6, dpi = 300, bg = "white")